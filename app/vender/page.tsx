...
import { ShoppingBag, Store, ArrowRight, Loader2, Package, TrendingUp, Shield } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          {[
            ...
            { icon: Shield, title: 'Sem burocracia', desc: 'Conta activa imediatamente, começa já a vender', color: 'text-purple-500', bg: 'bg-purple-50' },
          ].map(b => (
